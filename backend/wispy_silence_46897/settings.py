"""
Django settings for wispy_silence_46897 project.
...
ROOT_URLCONF = 'wispy_silence_46897.urls'
...
WSGI_APPLICATION = 'wispy_silence_46897.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_silence_46897 API",
    "DESCRIPTION": "API documentation for wispy_silence_46897 App",
    "VERSION": "v1",
}
